...
public class MixinHelper implements ModInitializer {
    ...
    public static final Map<Item, ImmutableCollection<ItemGroup>> ABSTRACT_ITEM_GROUP_TRANSFER_RULES = new AbstractMap<Item, ImmutableCollection<ItemGroup>>() {
        @NotNull
        @Override
    ...
    public void onInitialize() {
        ...
        LOGGER.info(String.format("%s rules are recognized!", ITEM_SORTING_RULES.size()));
