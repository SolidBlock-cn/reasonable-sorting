...
public class BlockFamilyRule implements Supplier<Collection<Map<Item, Collection<Item>>>> {
   ...
   */
  public static final @Unmodifiable Map<Item, Collection<Item>> FENCE_TO_FENCE_GATES = new AbstractMap<>() {
    @NotNull
    @Override
   ...
   */
  public static final ArrayList<BlockFamily.Variant> AFFECTED_VARIANTS = Lists.newArrayList(BlockFamily.Variant.STAIRS, BlockFamily.Variant.SLAB);
  /**
   ...
   */
  public static final @Unmodifiable Map<Item, Collection<Item>> BLOCK_ITEM_TO_VARIANTS = new AbstractMap<>() {
    @NotNull
    @Override
    public Set<Entry<Item, Collection<Item>>> entrySet() {
   ...
   */
  public static @Unmodifiable Collection<Map<Item, Collection<Item>>> getFenceToFenceGates() {
    return Collections.singleton(new ForwardingMap<>() {
      @Override
      protected @NotNull Map<Item, Collection<Item>> delegate() {
  ...
  @Override
  public @Unmodifiable Collection<Map<Item, Collection<Item>>> get() {
